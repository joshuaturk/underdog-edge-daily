...
export class GolfAnalysisService {
  ...
  private static addFallback3MOpenData(picks: GolfPick[]): GolfPick[] {
    // Current 3M Open 2025 scores - Friday July 25th (Round 2 completed)
    const currentScores = [
      ...
      { name: 'Akshay Bhatia', position: 7, score: -10, thru: 'F', round: 2, rounds: [66, 66], status: 'ACTIVE' },
      ...
      { name: 'Max Homa', position: 38, score: -5, thru: 'F', round: 2, rounds: [66, 69], status: 'ACTIVE' }
    ];
